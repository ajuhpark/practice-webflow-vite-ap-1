...
console.log('Script loaded, checking for sj_layout_three class...');
console.log('Body classes:', document.body.className);
console.log('Has sj_layout_three class:', document.body.classList.contains("sj_layout_three"));
console.log('Document ready state:', document.readyState);

if (document.body.classList.contains('sj_layout_three')) {
  console.log('✅ sj_layout_three class found, initializing...');
  sj_layout_three();
} else {
  console.warn('❌ sj_layout_three class NOT found on body element');
}
